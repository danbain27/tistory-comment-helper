...
# ─────────────────────────────────────────────
KEYWORDS = [
    # 무료 클라우드 속도를 위해 핵심 6개로 압축 (필요 시 추가 가능)
    "건프라 리뷰",
    "프라모델 제작",
    "슈퍼로봇대전 공략",
    "게임 리뷰",
...
MIN_DELAY, MAX_DELAY = 0.0, 0.3   # 요청 사이 대기(초) — 클라우드 속도 위해 최소화
MAX_SEARCH_SECONDS = 110          # 이 시간 넘으면 모은 만큼만 반환(500 방지 + 응답 빠르게)
...
RELEVANCE_TERMS = [
    # "리뷰"·"후기"처럼 아무 데나 붙는 단어는 넣지 않음 (명품백/맛집 후기 걸러내기)
    "건프라", "프라모델", "건담", "반다이", "도색", "먹선", "런너", "피규어", "디오라마", "프라모",
    "슈퍼로봇대전", "슈로대", "게임", "공략", "플레이", "클리어", "엔딩", "보스", "스테이지", "패치",
